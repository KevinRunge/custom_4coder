/*
kevin_custom_include.cpp - Default set of commands and setup used in 4coder with customizations.
*/
...
// NOTE(Kevin): Do not use the default hooks, but customized version only
// #include "4coder_default_hooks.cpp"
#include "kevin_custom_hooks.cpp"

/*
kevin_custom_hooks.cpp - Sets up the hooks and customized hooks for the default framework.
 include this file instead of te 4coder_default_hook.cpp
*/

// TOP

// NOTE(Kevin): Custom keyword highlighting, based on 
// https://4coder.handmade.network/wiki/7319-customization_layer_-_getting_started__4coder_4.1_
...
// NOTE(Kevin): End of custom functions
...
CUSTOM_DOC("Default command for responding to a startup event")
{
    ...
    if (match_core_code(&input, CoreCode_Startup)){
        ...
        // NOTE(Kevin): commenting next line results in starting up in single panel mode but does make the scatch buffer the visible buffer...
        // TODO(Kevin): how to change this behaviour? Files are loaded from command line
...
default_render_buffer(Application_Links *app, View_ID view_id, Face_ID face_id,
    ...
    if (token_array.tokens != 0){
        // NOTE(Kevin): use primitive highlight customization
    ...
    if (global_config.use_scope_highlight){
        ...
        // NOTE(Kevin): Call customized block version of scope highlighting
